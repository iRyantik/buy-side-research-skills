...
> v6.5.10 | Claude Code + Codex 双宿主 | [iRyantik/buy-side-research-skills](https://github.com/iRyantik/buy-side-research-skills)
...
| 版本 | 日期 | 主要变化 |
|---|---|---|
| v6.5.10 | 2026-06 | RAG 四层回退链（WebFetch→Playwright→curl→[需查证]）、Evidence Ledger（ticker-scoped 跨 artifact 复用）、句尾锚全 skill 覆盖、16 hook 回归测试、actuals source_map provenance、Fill-Gaps 统一回退 |
...
| v6.5.10 | 2026-05 | Runtime Capsule 标准化、market data trust-based fill、C-level modeling hooks |
