...
> v7.3.1 | Claude Code + Codex 双宿主 | [iRyantik/buy-side-research-skills](https://github.com/iRyantik/buy-side-research-skills)
...
| 版本 | 日期 | 主要变化 |
|---|---|---|
| v7.3.1 | 2026-07 | driver-map v1.5.1: Sum of Q = Y (Annual=ΣQ 公式化), checks.json + q_checks + threshold flags, vol_asp Q driver 修复, Lumentum seg OP reconciliation, checks.json 路径与 JSON 同目录 |
