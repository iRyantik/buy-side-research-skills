...
> v6.5.5 | Claude Code + Codex Dual-Host | [iRyantik/buy-side-research-skills](https://github.com/iRyantik/buy-side-research-skills)
>
...
|---|---|---|
| v6.5.5 | 2026-06-22 | coverage-monitor renderer polish: ticker-first mover cards, compact Core Watch cards, native+English company names with dedupe, unified `Evidence` disclosure for filing/official links, and canonical `Core Coverage` / `Building Coverage` / `Core Watch` / `Daily Watch` runtime state. |
