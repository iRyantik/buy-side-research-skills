...
在 [GitHub Release 页面](https://github.com/iRyantik/buy-side-research-skills/releases) 找到最新版本，下载 `longbridge-skills.zip`。解压后，在 Claude Code 里说：
...
然后跟 Claude 说 "帮我查一下 TSLA 的最新行情" 确认可用。
