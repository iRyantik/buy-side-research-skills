...
> v5.13.1 | Claude Code + Codex Dual-Host | [iRyantik/buy-side-research-skills](https://github.com/iRyantik/buy-side-research-skills)
>
...
|---|---|---|
| v5.13.1 | 2026-06 | Moat analysis: causal chain + falsification conditions per dimension, paradigm-shift moat template (segment-level causal transmission) |
