...
> v5.19.0 | Claude Code + Codex Dual-Host | [iRyantik/buy-side-research-skills](https://github.com/iRyantik/buy-side-research-skills)
>
...
|---|---|---|
| v5.19.0 | 2026-06-11 | Bugfix spectrum: #4 auto-create dir, #11 evidence_ledger -t optional, #5/#7/#9 fill engine (market_data+revenue_split+FY supplement), #3 table corruption, #12 column count, #14 UNVERIFIED exclude, #15 403 domains, #10/#13 Unicode |
