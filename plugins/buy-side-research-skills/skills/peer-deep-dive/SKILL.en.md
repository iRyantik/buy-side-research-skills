...
> **Appendix execution**: Run `python _scripts/financial-data/actuals-to-appendix.py --tickers ...` BEFORE writing the artifact body. Embed output in `## Appendix: Financial Data` above. Never leave a placeholder.
