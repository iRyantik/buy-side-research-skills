...
Usage:
  python describe-figures.py topics/<topic>/_cache/source-file.md
  python describe-figures.py topics/<topic>/_cache/ --recursive
  python describe-figures.py topics/<topic>/_cache/source-file.md --api-url http://localhost:11434/v1 --model llava
  python describe-figures.py topics/<topic>/_cache/source-file.md --print-pending  # just list pending figures
