...
（同上结构——为什么重要 / 长这样 / 在什么位置 / 怎么收钱。如果产品线没有合适的图，跳过长这样）

> 图片只放焦点业务的。其他业务不配图。① 公司官网 Media Kit → ② web search 产品图 → ③ 搜不到就不放。
...
> 数字来源：`topics/company/<slug>/_cache/financial-data/internal/actuals-resolved.json`
...
**§5 驱动因素**
- ❌ 只写了教科书答案（"需求、竞争、成本"）——没讲当前 regime 特有的变量
- ❌ 缺"这门生意怎么转" / 缺"行业在发生什么" / 缺"情绪怎么变" / 缺"放在一起看"
