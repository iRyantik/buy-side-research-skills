...
> This is the English translation of [global-map.md](./global-map.md). The Chinese version is the source of truth.
...
|---|---|
| "Map where Company A has factories" | Markers (sized by capacity) |
...
<div class="figure-slide">
  ...
  <p class="chart-subtitle">Marker area proportional to 12-inch equivalent monthly wafer capacity (kwpm), FY2025E</p>
  <div id="chart"></div>
