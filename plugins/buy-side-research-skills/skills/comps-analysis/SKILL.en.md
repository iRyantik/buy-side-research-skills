...
Each subagent independently completes two tasks:
  ...
  a. Fetch financial data
     ...
     → writes canonical facts-store.json and generates read-only actuals-resolved.json
...
|---|---|---|---|---|
| 1 | EV | Mkt Cap + Total Debt + Pref + Minority - Cash | MKT, FS | Check if restricted cash should be excluded; prefer book debt |
| 2 | EV/EBITDA | EV ÷ EBITDA | DER, FS | Non-recurring items need adjustment; Chinese companies often lack segment EBITDA |
| 3 | EV/Sales | EV ÷ Revenue | DER, FS | Misleading when gross margin differences are large; suitable for growth stocks, mature stocks better with EV/EBITDA |
| 4 | P/E | Price ÷ EPS (diluted) | MKT, FS | GAAP vs non-GAAP; meaningless for loss-making companies |
| 5 | P/B | Price ÷ BV per Share | MKT, FS | Inflated with large goodwill; suitable for financial/real estate, large deviations for manufacturing/tech |
| 6 | FCF Yield | (OCF - CapEx) ÷ Mkt Cap | DER, MKT | Prefer total CapEx, do not split maintenance |
