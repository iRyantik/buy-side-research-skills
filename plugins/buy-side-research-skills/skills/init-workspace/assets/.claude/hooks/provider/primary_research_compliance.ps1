...
$riskyBusinessPattern = '(?i)(order(s)?|guidance|customer list|specific customer|contract terms|margin by customer|procurement plan|pipeline|backlog by customer|next quarter|next-half|\u8BA2\u5355|\u6307\u5F15|\u5BA2\u6237\u540D\u5355|\u5177\u4F53\u5BA2\u6237|\u5408\u540C\u6761\u6B3E|\u5B9A\u4EF7|\u4EF7\u683C\u70B9|\u5BA2\u6237\u6BDB\u5229|\u91C7\u8D2D\u8BA1\u5212|\u7BA1\u7EBF|\u8BA2\u5355\u50A8\u5907|\u4E0B\u5B63\u5EA6|\u4E0B\u534A\u5E74)'
