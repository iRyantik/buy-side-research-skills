...
def main() -> int:
    parser = argparse.ArgumentParser(description="Compare PDFPlumber table numerics against Docling/cache markdown.")
    parser.add_argument("pdf_path", help="Original PDF path.")
    parser.add_argument("markdown_path", help="Markdown produced by ingest/Docling.")
