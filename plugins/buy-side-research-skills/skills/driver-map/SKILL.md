...
- Claim-Level Source Contract：正文里的每个 truth-like claim（driver、segment、backlog、price / volume / mix、margin bridge、披露口径变化）都必须紧跟可点击短 anchor，如 `[S1]` / `[P1]`。
...
|---|---|---|---|---|
| [segment / product] | [实际卖什么 / 做什么] | [客户或应用] | [S1] | [缺口] |
