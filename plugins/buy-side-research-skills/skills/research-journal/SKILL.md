...
- Claim-Level Source Contract：journal 只沉淀 source-backed settled insight；每个保留下来的 truth-like claim 都必须紧跟可点击短 anchor，如 `[S1]` / `[P1]`。
...
**结论先行**
[1-2 句话说清楚已经赚到的 insight，例如：`订单结构的变化比总 backlog 更能解释 margin inflection；FY25 服务订单占比提升至 42%。 [S1]`]
