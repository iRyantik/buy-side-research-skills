...
全局 source / anti-hallucination 规则已内嵌在 `Global Rules Capsule (v1)`。本节只补充 industry-quickread-specific 要求。
...
| 维度 | 当前判断 | Evidence | Source |
|---|---|---|---|
| Demand | 加速 / 放缓 / 结构性替换 / 补库存 | [具体指标] | [source] |
...
| Name | Market | Value chain role | Exposure 类型 | 为什么是 anchor | Source 状态 |
|---|---|---|---|---|---|
| [ticker/company] | [US/A/HK/etc.] | [stage] | direct / indirect / thematic / [需查证] | [定位作用] | [source / 来源待补] |
